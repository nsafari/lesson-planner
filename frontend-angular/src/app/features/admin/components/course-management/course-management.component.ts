  ...
  template: `
    ...
    <header class="site-header">
      <div class="d-flex align-items-center gap-2">
        ...
        <h4 class="text-white mb-0">مدیریت دوره‌ها</h4>
      </div>
    ...
    <div class="dashboard-container bg-white row flex-nowrap">
      ...
      <aside class="col-12 col-md-3 sidebar" id="sidebarMenu">
        <div class="admin-menu flex-md-column">
          ...
          <button class="admin-btn active" (click)="navigateTo('courses')">
      ...
      <main class="col-12 col-md-9 main-content">
        <h2 class="text-center mb-4">مدیریت دوره‌ها</h2>
        
        <div class="alert alert-info">
          <i class="bi bi-info-circle me-2"></i>
          این بخش در حال توسعه است. به زودی قابلیت‌های مدیریت دوره‌ها اضافه خواهد شد.
        </div>
      </main>
    </div>
  `,
